...
<!-- TOC -->autoauto- [1. Unidad didática 1: Elementos del desarrollo de software](#1-unidad-didática-1-elementos-del-desarrollo-de-software)auto    - [1.1. Introducción: un poco de historia](#11-introducción-un-poco-de-historia)auto    - [1.2. Programa y aplicación informática](#12-programa-y-aplicación-informática)auto    - [1.3. Lenguajes de programación](#13-lenguajes-de-programación)auto        - [1.3.1. Definición de lenguaje](#131-definición-de-lenguaje)auto        - [1.3.2. Elementos de un lenguaje de programación](#132-elementos-de-un-lenguaje-de-programación)auto        - [1.3.3. Tipos de lenguajes de programación](#133-tipos-de-lenguajes-de-programación)auto        - [1.3.4. Tipos de código generados por un lenguaje de programación](#134-tipos-de-código-generados-por-un-lenguaje-de-programación)auto        - [1.3.5. Paradigmas de programación](#135-paradigmas-de-programación)auto        - [1.3.6. La programación estructurada](#136-la-programación-estructurada)auto        - [1.3.7. La programación orientada a objetos](#137-la-programación-orientada-a-objetos)auto    - [1.4. El lenguaje de programación Java](#14-el-lenguaje-de-programación-java)auto        - [1.4.1. Historia del lenguaje Java](#141-historia-del-lenguaje-java)auto        - [1.4.2. Características del lenguaje Java](#142-características-del-lenguaje-java)auto        - [1.4.3. La máquina virtual de Java (JVM)](#143-la-máquina-virtual-de-java-jvm)auto    - [1.5. Fases en el desarrollo de una aplicación](#15-fases-en-el-desarrollo-de-una-aplicación)auto        - [1.5.1. Metodología para el desarrollo de software](#151-metodología-para-el-desarrollo-de-software)auto        - [1.5.2. Ciclo de vida del software](#152-ciclo-de-vida-del-software)auto        - [1.5.3. Análisis](#153-análisis)auto        - [1.5.4. Diseño](#154-diseño)auto        - [1.5.5. Implementación o codificación](#155-implementación-o-codificación)auto        - [1.5.6. Pruebas](#156-pruebas)auto        - [1.5.7. Documentación](#157-documentación)auto        - [1.5.8. Explotación y Mantenimiento](#158-explotación-y-mantenimiento)auto        - [1.5.9. Metodologías ágiles](#159-metodologías-ágiles)auto        - [1.5.10. Scrum](#1510-scrum)auto            - [1.5.10.1. Fases de una iteración](#15101-fases-de-una-iteración)auto            - [1.5.10.2. Roles en un proyecto Scrum](#15102-roles-en-un-proyecto-scrum)auto            - [1.5.10.3. Beneficios de usar Scrum](#15103-beneficios-de-usar-scrum)auto    - [1.6. Bibliografía](#16-bibliografía)autoauto<!-- /TOC -->
